...
CASE(1,2)
  ...
  !$ACC PARALLEL DEFAULT(NONE) PRESENT(PRE_UM, PTEMPERATURE, YDERAD) ASYNC(1) IF(lacc)
...
CASE(3)
  ...
  !$ACC     ZMIN_DIAMETER_UM, YDERAD, PRE_UM) ASYNC(1) IF(lacc)
