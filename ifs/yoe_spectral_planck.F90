...
CONTAINS
  PROCEDURE :: INIT => INIT_SPECTRAL_PLANCK
  PROCEDURE :: CALC => CALC_SPECTRAL_PLANCK
...
SUBROUTINE INIT_SPECTRAL_PLANCK(SELF, KINTERVALS, PWAVLEN_BOUND, KINTERVAL_MAP)
...
END SUBROUTINE INIT_SPECTRAL_PLANCK


!-----------------------------------------------------------------------
! Calculate Planck function in spectral intervals from temperature
SUBROUTINE CALC_SPECTRAL_PLANCK(SELF, KIDIA, KFDIA, KLON, PTEMPERATURE, PPLANCK)
...
END SUBROUTINE CALC_SPECTRAL_PLANCK
