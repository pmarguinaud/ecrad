!***************************************************************************
SUBROUTINE RRTM_INIT_140GP_GPU(CDIRECTORY, lacc)
!***************************************************************************
...
CALL RRTM_CMBGB1_GPU(lacc=lacc)
CALL RRTM_CMBGB2_GPU(lacc=lacc)
CALL RRTM_CMBGB3_GPU(lacc=lacc)
CALL RRTM_CMBGB4_GPU(lacc=lacc)
CALL RRTM_CMBGB5_GPU(lacc=lacc)
CALL RRTM_CMBGB6_GPU(lacc=lacc)
CALL RRTM_CMBGB7_GPU(lacc=lacc)
CALL RRTM_CMBGB8_GPU(lacc=lacc)
CALL RRTM_CMBGB9_GPU(lacc=lacc)
CALL RRTM_CMBGB10_GPU(lacc=lacc)
CALL RRTM_CMBGB11_GPU(lacc=lacc)
CALL RRTM_CMBGB12_GPU(lacc=lacc)
CALL RRTM_CMBGB13_GPU(lacc=lacc)
CALL RRTM_CMBGB14_GPU(lacc=lacc)
CALL RRTM_CMBGB15_GPU(lacc=lacc)
CALL RRTM_CMBGB16_GPU(lacc=lacc)
...
!***************************************************************************
SUBROUTINE RRTM_INIT_140GP_CPU(CDIRECTORY)
!***************************************************************************
!     Reformatted for F90 by JJMorcrette, ECMWF, 980714
...
CALL RRTM_CMBGB1_CPU
CALL RRTM_CMBGB2_CPU
CALL RRTM_CMBGB3_CPU
CALL RRTM_CMBGB4_CPU
CALL RRTM_CMBGB5_CPU
CALL RRTM_CMBGB6_CPU
CALL RRTM_CMBGB7_CPU
CALL RRTM_CMBGB8_CPU
CALL RRTM_CMBGB9_CPU
CALL RRTM_CMBGB10_CPU
CALL RRTM_CMBGB11_CPU
CALL RRTM_CMBGB12_CPU
CALL RRTM_CMBGB13_CPU
CALL RRTM_CMBGB14_CPU
CALL RRTM_CMBGB15_CPU
CALL RRTM_CMBGB16_CPU
