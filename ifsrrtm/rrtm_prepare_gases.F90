...
!$ACC              PAVEL, PTAVEL, PZ, PTZ , KREFLECT) IF(lacc)
...
END SUBROUTINE RRTM_PREPARE_GASES_GPU


SUBROUTINE RRTM_PREPARE_GASES_CPU &
 &( KIDIA, KFDIA, KLON, KLEV, &
 &  PAPH , PAP , &
 &  PTH  , PT  , &
 &  PQ   , PCO2 , PCH4, PN2O  , PNO2, PC11, PC12, PC22, PCL4, POZN, &
...
END SUBROUTINE RRTM_PREPARE_GASES_CPU
