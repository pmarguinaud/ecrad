SUBROUTINE RRTM_SETCOEF_140GP_GPU (KIDIA,KFDIA,KLEV,P_COLDRY,P_WBROAD,P_WKL,&
 ...
 & PRAT_N2OCO2, PRAT_N2OCO2_1, PRAT_O3CO2, PRAT_O3CO2_1, lacc)
...
!$ACC   PRAT_H2ON2O_1, PRAT_H2OCH4, PRAT_H2OCH4_1, PRAT_N2OCO2, PRAT_N2OCO2_1, PRAT_O3CO2, PRAT_O3CO2_1) ASYNC(1) IF(lacc)
...
END SUBROUTINE RRTM_SETCOEF_140GP_GPU


SUBROUTINE RRTM_SETCOEF_140GP_CPU (KIDIA,KFDIA,KLEV,P_COLDRY,P_WBROAD,P_WKL,&
 & P_FAC00,P_FAC01,P_FAC10,P_FAC11,P_FORFAC,P_FORFRAC,K_INDFOR,K_JP,K_JT,K_JT1,&
 & P_COLH2O,P_COLCO2,P_COLO3,P_COLN2O,P_COLCH4, P_COLO2,P_CO2MULT, P_COLBRD, &
 & K_LAYTROP,K_LAYSWTCH,K_LAYLOW,PAVEL,P_TAVEL,P_SELFFAC,P_SELFFRAC,K_INDSELF,&
 & K_INDMINOR,P_SCALEMINOR,P_SCALEMINORN2,P_MINORFRAC,&
...
END SUBROUTINE RRTM_SETCOEF_140GP_CPU
