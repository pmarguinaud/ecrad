!*******************************************************************************
SUBROUTINE RRTM_TAUMOL10_GPU (KIDIA,KFDIA,KLEV,taug,&
...
REAL(KIND=JPRB) :: taufor,tauself
    ...
    !$ACC             indfor, forfrac, forfac) IF(lacc)
...
!$NEC unroll(NG10)
            ...
            do ig = 1, ng10
              ...
              taug(jl,ngs9+ig,lay) = colh2o(jl,lay) * &
                  ...
                  fac01(jl,lay) * absa(ind1,ig) + &
                  fac11(jl,lay) * absa(ind1+1,ig))  &
                  + tauself + taufor + p_tauaerl(jl,lay,10)
              fracs(jl,ngs9+ig,lay) = fracrefa(ig)
            enddo
         else
...
END SUBROUTINE RRTM_TAUMOL10_GPU


!*******************************************************************************
SUBROUTINE RRTM_TAUMOL10_CPU (KIDIA,KFDIA,KLEV,taug,&
 & P_TAUAERL,fac00,fac01,fac10,fac11,forfac,forfrac,indfor,jp,jt,jt1,&
...
END SUBROUTINE RRTM_TAUMOL10_CPU
