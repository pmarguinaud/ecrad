!******************************************************************************
SUBROUTINE RRTM_TAUMOL11_GPU (KIDIA,KFDIA,KLEV,taug,&
...
REAL(KIND=JPRB) :: taufor,tauself,scaleO2, tauO2
    ...
    !$ACC             indfor, forfac, forfrac, minorfrac, indminor, scaleminor) IF(lacc)
...
END SUBROUTINE RRTM_TAUMOL11_GPU


!******************************************************************************
SUBROUTINE RRTM_TAUMOL11_CPU (KIDIA,KFDIA,KLEV,taug,&
 & P_TAUAERL,fac00,fac01,fac10,fac11,forfac,forfrac,indfor,jp,jt,jt1,&
 & colh2o,colo2,laytrop,selffac,selffrac,indself,fracs,minorfrac, &
 & indminor,scaleminor)
...
END SUBROUTINE RRTM_TAUMOL11_CPU
