!----------------------------------------------------------------------------
SUBROUTINE RRTM_TAUMOL13_GPU (KIDIA,KFDIA,KLEV,taug,&
 ...
 & rat_h2on2o, rat_h2on2o_1,minorfrac,indminor, lacc)
...
!$NEC unroll(NG13)
          do ig = 1, ng13
            ...
            taug(jl,ngs12+ig,lay) = tau_major(ig) + tau_major1(ig) &
                 + tauself + taufor &
                 + adjcolco2*absco2 &
                 + colco(jl,lay)*absco + p_tauaerl(jl,lay,13)
...
!$NEC unroll(NG13)
          do ig = 1, ng13
            ...
            taug(jl,ngs12+ig,lay) = colo3(jl,lay)*abso3 + p_tauaerl(jl,lay,13)
...
END SUBROUTINE RRTM_TAUMOL13_GPU


!----------------------------------------------------------------------------
SUBROUTINE RRTM_TAUMOL13_CPU (KIDIA,KFDIA,KLEV,taug,&
 & P_TAUAERL,fac00,fac01,fac10,fac11,forfac,forfrac,indfor,jp,jt,jt1,oneminus,&
 & colh2o,coln2o,colco2,colo3,coldry,laytrop,selffac,selffrac,indself,fracs, &
...
END SUBROUTINE RRTM_TAUMOL13_CPU
