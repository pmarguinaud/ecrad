!******************************************************************************
SUBROUTINE RRTM_TAUMOL14_GPU (KIDIA,KFDIA,KLEV,taug,&
 & P_TAUAERL,fac00,fac01,fac10,fac11,forfac,forfrac,indfor,jp,jt,jt1,&
 & colco2,laytrop,selffac,selffrac,indself,fracs, lacc)
...
REAL(KIND=JPRB) :: taufor,tauself
    ...
    !$ACC             indfor, forfac, forfrac) IF(lacc)
...
!$NEC unroll(NG14)
          do ig = 1, ng14
            ...
            taug(jl,ngs13+ig,lay) = colco2(jl,lay) * &
                 ...
                 + tauself + taufor + p_tauaerl(jl,lay,14)
...
!$NEC unroll(NG14)
          do ig = 1, ng14
            taug(jl,ngs13+ig,lay) = colco2(jl,lay) * &
                 ...
                 fac11(jl,lay) * absb(ind1+1,ig)) + p_tauaerl(jl,lay,14)
...
END SUBROUTINE RRTM_TAUMOL14_GPU


!******************************************************************************
SUBROUTINE RRTM_TAUMOL14_CPU (KIDIA,KFDIA,KLEV,taug,&
 & P_TAUAERL,fac00,fac01,fac10,fac11,forfac,forfrac,indfor,jp,jt,jt1,&
...
END SUBROUTINE RRTM_TAUMOL14_CPU
