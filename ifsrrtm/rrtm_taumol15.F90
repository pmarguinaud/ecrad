!----------------------------------------------------------------------------
SUBROUTINE RRTM_TAUMOL15_GPU (KIDIA,KFDIA,KLEV,taug,&
 ...
 & rat_n2oco2, rat_n2oco2_1,minorfrac,indminor,scaleminor,colbrd, lacc)
...
& fpl, specmult_planck, specparm_planck,speccomb_planck
    ...
    !$ACC             forfrac, minorfrac, indminor, scaleminor, colbrd) IF(lacc)
...
END SUBROUTINE RRTM_TAUMOL15_GPU


!----------------------------------------------------------------------------
SUBROUTINE RRTM_TAUMOL15_CPU (KIDIA,KFDIA,KLEV,taug,&
 & P_TAUAERL,fac00,fac01,fac10,fac11,forfac,forfrac,indfor,jp,jt,jt1,oneminus,&
 & colh2o,colco2,coln2o,laytrop,selffac,selffrac,indself,fracs, &
...
END SUBROUTINE RRTM_TAUMOL15_CPU
