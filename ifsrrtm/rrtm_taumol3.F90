!----------------------------------------------------------------------------
SUBROUTINE RRTM_TAUMOL3_GPU (KIDIA,KFDIA,KLEV,taug,&
 ...
 & RAT_H2OCO2, RAT_H2OCO2_1,MINORFRAC,INDMINOR, lacc)
...
REAL(KIND=JPRB) :: ZHOOK_HANDLE
    ...
    !$ACC             RAT_H2OCO2_1, INDFOR, FORFRAC, MINORFRAC, INDMINOR) IF(lacc)
...
!$NEC unroll(NG3)
          do ig = 1, ng3
            ...
            taug(jl,ngs2+ig,lay) = tau_major(ig) + tau_major1(ig) &
                 + tauself + taufor &
                 + adjcoln2o*absn2o + p_tauaerl(jl,lay,3)
...
END SUBROUTINE RRTM_TAUMOL3_GPU


!----------------------------------------------------------------------------
SUBROUTINE RRTM_TAUMOL3_CPU (KIDIA,KFDIA,KLEV,taug,&
 & P_TAUAERL,FAC00,FAC01,FAC10,FAC11,FORFAC,FORFRAC,INDFOR,JP,JT,jt1,ONEMINUS,&
 & COLH2O,COLCO2,COLN2O,COLDRY,LAYTROP,SELFFAC,SELFFRAC,INDSELF,FRACS, &
...
END SUBROUTINE RRTM_TAUMOL3_CPU
