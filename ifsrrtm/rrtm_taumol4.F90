!----------------------------------------------------------------------------
SUBROUTINE RRTM_TAUMOL4_GPU (KIDIA,KFDIA,KLEV,taug,&
 ...
 & rat_h2oco2, rat_h2oco2_1, rat_o3co2, rat_o3co2_1, lacc)
...
!$NEC unroll(NG4)
          do ig = 1, ng4
            ...
            taug(jl,ngs3+ig,lay) = tau_major(ig) + tau_major1(ig) &
                 + tauself + taufor + p_tauaerl(jl,lay,4)
...
!$NEC unroll(NG4)
          do ig = 1, ng4
            taug(jl,ngs3+ig,lay) =  speccomb * &
                 ...
                 fac111 * absb(ind1+6,ig)) + p_tauaerl(jl,lay,4)
...
END SUBROUTINE RRTM_TAUMOL4_GPU


!----------------------------------------------------------------------------
SUBROUTINE RRTM_TAUMOL4_CPU (KIDIA,KFDIA,KLEV,taug,&
 & P_TAUAERL,fac00,fac01,fac10,fac11,forfac,forfrac,indfor,jp,jt,jt1,oneminus,&
 & colh2o,colco2,colo3,laytrop,selffac,selffrac,indself,fracs, &
...
END SUBROUTINE RRTM_TAUMOL4_CPU
