!----------------------------------------------------------------------------
SUBROUTINE RRTM_TAUMOL5_GPU (KIDIA,KFDIA,KLEV,taug,wx,&
 ...
 & rat_h2oco2, rat_h2oco2_1, rat_o3co2, rat_o3co2_1,minorfrac,indminor, lacc)
...
& fmo3, specmult_MO3, specparm_MO3
    ...
    !$ACC             rat_o3co2_1, indfor, forfrac, forfac, minorfrac, indminor) IF(lacc)
...
!$NEC unroll(NG5)
          do ig = 1, ng5
            ...
            taug(jl,ngs4+ig,lay) = tau_major(ig) + tau_major1(ig) &
                 + tauself + taufor &
                 + abso3*colo3(jl,lay) &
                 + wx(jl,1,lay) * ccl4(ig) + p_tauaerl(jl,lay,5)
...
END SUBROUTINE RRTM_TAUMOL5_GPU


!----------------------------------------------------------------------------
SUBROUTINE RRTM_TAUMOL5_CPU (KIDIA,KFDIA,KLEV,taug,wx,&
 & P_TAUAERL,fac00,fac01,fac10,fac11,forfac,forfrac,indfor,jp,jt,jt1,oneminus,&
 & colh2o,colco2, colo3,laytrop,selffac,selffrac,indself,fracs, &
...
END SUBROUTINE RRTM_TAUMOL5_CPU
