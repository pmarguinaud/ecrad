!----------------------------------------------------------------------------
SUBROUTINE RRTM_TAUMOL6_GPU (KIDIA,KFDIA,KLEV,taug,wx,&
 & P_TAUAERL,fac00,fac01,fac10,fac11,forfac,forfrac,indfor,jp,jt,jt1,&
 & colh2o,colco2,coldry,laytrop,selffac,selffrac,indself,fracs,minorfrac,indminor, lacc)
...
!$NEC unroll(NG6)
          do ig = 1, ng6
            ...
            taug(jl,ngs5+ig,lay) = colh2o(jl,lay) * &
                 ...
                 + wx(jl,3,lay) * cfc12(ig) + p_tauaerl(jl,lay,6)
...
END SUBROUTINE RRTM_TAUMOL6_GPU


!----------------------------------------------------------------------------
SUBROUTINE RRTM_TAUMOL6_CPU (KIDIA,KFDIA,KLEV,taug,wx,&
 & P_TAUAERL,fac00,fac01,fac10,fac11,forfac,forfrac,indfor,jp,jt,jt1,&
...
END SUBROUTINE RRTM_TAUMOL6_CPU
