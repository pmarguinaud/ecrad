!----------------------------------------------------------------------------
SUBROUTINE RRTM_TAUMOL7_GPU (KIDIA,KFDIA,KLEV,taug,&
 ...
 & rat_h2oo3, rat_h2oo3_1,minorfrac,indminor, lacc)
...
& fmco2, specmult_mco2, specparm_mco2
    ...
    !$ACC             minorfrac, indminor) IF(lacc)
...
!$NEC unroll(NG7)
          do ig = 1, ng7
            ...
            taug(jl,ngs6+ig,lay) = tau_major(ig) + tau_major1(ig) &
                 + tauself + taufor &
                 + adjcolco2*absco2 + p_tauaerl(jl,lay,7)
...
END SUBROUTINE RRTM_TAUMOL7_GPU


!----------------------------------------------------------------------------
SUBROUTINE RRTM_TAUMOL7_CPU (KIDIA,KFDIA,KLEV,taug,&
 & P_TAUAERL,fac00,fac01,fac10,fac11,forfac,forfrac,indfor,jp,jt,jt1,oneminus,&
 & colh2o,colo3,colco2,coldry,laytrop,selffac,selffrac,indself,fracs, &
...
END SUBROUTINE RRTM_TAUMOL7_CPU
