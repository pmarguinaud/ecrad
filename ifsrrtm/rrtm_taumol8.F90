!*******************************************************************************
SUBROUTINE RRTM_TAUMOL8_GPU (KIDIA,KFDIA,KLEV,taug,wx,&
...
!$NEC unroll(NG8)
          do ig = 1, ng8
            ...
            taug(jl,ngs7+ig,lay) = colh2o(jl,lay) * &
                 ...
                 + wx(jl,4,lay) * cfc22adj(ig) + p_tauaerl(jl,lay,8)
...
END SUBROUTINE RRTM_TAUMOL8_GPU


!*******************************************************************************
SUBROUTINE RRTM_TAUMOL8_CPU (KIDIA,KFDIA,KLEV,taug,wx,&
 & P_TAUAERL,fac00,fac01,fac10,fac11,forfac,forfrac,indfor,jp,jt,jt1,&
 & colh2o,colo3,coln2o,colco2,coldry,laytrop,selffac,selffrac,indself,fracs, &
 & minorfrac,indminor)
...
END SUBROUTINE RRTM_TAUMOL8_CPU
