!----------------------------------------------------------------------------
SUBROUTINE RRTM_TAUMOL9_GPU (KIDIA,KFDIA,KLEV,taug,&
 ...
 & rat_h2och4,rat_h2och4_1,minorfrac,indminor, lacc)
...
REAL(KIND=JPRB) :: taufor,tauself,n2om1,n2om2,absn2o,tau_major(ng9),tau_major1(ng9)
    ...
    !$ACC             rat_h2och4_1, indfor, forfac, forfrac, minorfrac, indminor) IF(lacc)
...
!$NEC unroll(NG9)
          do ig = 1, ng9
            ...
            taug(jl,ngs8+ig,lay) = tau_major(ig) + tau_major1(ig) &
                 + tauself + taufor &
                 + adjcoln2o*absn2o + p_tauaerl(jl,lay,9)
...
END SUBROUTINE RRTM_TAUMOL9_GPU


!----------------------------------------------------------------------------
SUBROUTINE RRTM_TAUMOL9_CPU (KIDIA,KFDIA,KLEV,taug,&
 & P_TAUAERL,fac00,fac01,fac10,fac11,forfac,forfrac,indfor,jp,jt,jt1,oneminus,&
 & colh2o,coln2o,colch4,coldry,laytrop,K_LAYSWTCH,K_LAYLOW,selffac,selffrac,indself,fracs, &
...
END SUBROUTINE RRTM_TAUMOL9_CPU
