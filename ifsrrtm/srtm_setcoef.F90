...
!$ACC   KJP, KJT,KJT1, PRMU0) ASYNC(1) IF(lacc)
!$ACC LOOP SEQ
DO JK = 1, KLEV
...
END SUBROUTINE SRTM_SETCOEF_GPU


SUBROUTINE SRTM_SETCOEF_CPU &
 & ( KIDIA   , KFDIA    , KLEV    ,&
 &   PAVEL   , PTAVEL   ,&
 &   PCOLDRY , PWKL     ,&
 &   KLAYTROP,&
...
END SUBROUTINE SRTM_SETCOEF_CPU
