...
logical, intent (in) :: lacc
    ...
    !$ACC             K_INDFOR, P_SFLUXZEN, P_TAUG, P_TAUR, PRMU0) IF(lacc)
...
END SUBROUTINE SRTM_TAUMOL21_GPU


SUBROUTINE SRTM_TAUMOL21_CPU &
 & ( KIDIA   , KFDIA    , KLEV,&
 & P_FAC00   , P_FAC01  , P_FAC10   , P_FAC11,&
 & K_JP      , K_JT     , K_JT1     , P_ONEMINUS,&
 & P_COLH2O  , P_COLCO2 , P_COLMOL,&
...
END SUBROUTINE SRTM_TAUMOL21_CPU
