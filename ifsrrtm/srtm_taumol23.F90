...
logical, intent (in) :: lacc
    ...
    !$ACC             p_taug, p_taur , prmu0) IF(lacc)
...
END SUBROUTINE SRTM_TAUMOL23_GPU


SUBROUTINE SRTM_TAUMOL23_CPU &
 & ( KIDIA   , KFDIA    , KLEV,&
 & P_FAC00   , P_FAC01  , P_FAC10   , P_FAC11,&
 & K_JP      , K_JT     , K_JT1,&
 & P_COLH2O  , P_COLMOL,&
...
END SUBROUTINE SRTM_TAUMOL23_CPU
