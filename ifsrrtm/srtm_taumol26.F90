SUBROUTINE SRTM_TAUMOL26_GPU &
 & ( KIDIA   , KFDIA    , KLEV,&
 & P_COLMOL  ,K_LAYTROP,&
 & P_SFLUXZEN, P_TAUG   , P_TAUR    , PRMU0, lacc   &
 & )  
...
logical, intent (in) :: lacc
    ...
    !$ACC     PRESENT(p_colmol, k_laytrop, p_sfluxzen, p_taug, p_taur, prmu0) IF(lacc)
...
END SUBROUTINE SRTM_TAUMOL26_GPU


SUBROUTINE SRTM_TAUMOL26_CPU &
 & ( KIDIA   , KFDIA    , KLEV,&
 & P_COLMOL  ,K_LAYTROP,&
...
END SUBROUTINE SRTM_TAUMOL26_CPU
