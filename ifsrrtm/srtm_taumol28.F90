...
logical, intent (in) :: lacc
    ...
    !$ACC             P_SFLUXZEN, P_TAUG, P_TAUR, PRMU0) IF(lacc)
...
END SUBROUTINE SRTM_TAUMOL28_GPU


SUBROUTINE SRTM_TAUMOL28_CPU &
 & ( KIDIA   , KFDIA    , KLEV,&
 & P_FAC00   , P_FAC01  , P_FAC10   , P_FAC11,&
 & K_JP      , K_JT     , K_JT1     , P_ONEMINUS,&
 & P_COLMOL  , P_COLO2  , P_COLO3,&
...
END SUBROUTINE SRTM_TAUMOL28_CPU
