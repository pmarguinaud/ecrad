INTERFACE
SUBROUTINE RRTM_TAUMOL3_GPU (KIDIA,KFDIA,KLEV,P_TAU,&
 ...
 & PRAT_H2OCO2, PRAT_H2OCO2_1,PMINORFRAC,KINDMINOR, lacc) 
...
END INTERFACE
INTERFACE
SUBROUTINE RRTM_TAUMOL3_CPU (KIDIA,KFDIA,KLEV,P_TAU,&
 & P_TAUAERL,P_FAC00,P_FAC01,P_FAC10,P_FAC11,P_FORFAC,P_FORFRAC,K_INDFOR,K_JP,K_JT,K_JT1,P_ONEMINUS,&
 & P_COLH2O,P_COLCO2,P_COLN2O,P_COLDRY,K_LAYTROP,P_SELFFAC,P_SELFFRAC,K_INDSELF,PFRAC,&
