INTERFACE
SUBROUTINE RRTM_TAUMOL4_GPU (KIDIA,KFDIA,KLEV,P_TAU,&
 ...
 & P_RAT_H2OCO2, P_RAT_H2OCO2_1, P_RAT_O3CO2, P_RAT_O3CO2_1, lacc) 
...
END INTERFACE
INTERFACE
SUBROUTINE RRTM_TAUMOL4_CPU (KIDIA,KFDIA,KLEV,P_TAU,&
 & P_TAUAERL,P_FAC00,P_FAC01,P_FAC10,P_FAC11,P_FORFAC,P_FORFRAC,K_INDFOR,K_JP,K_JT,K_JT1,P_ONEMINUS,&
 & P_COLH2O,P_COLCO2,P_COLO3,K_LAYTROP,P_SELFFAC,P_SELFFRAC,K_INDSELF,PFRAC,&
