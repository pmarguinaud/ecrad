INTERFACE
SUBROUTINE RRTM_TAUMOL7_GPU (KIDIA,KFDIA,KLEV,P_TAU,&
 ...
 & P_RAT_H2OO3, P_RAT_H2OO3_1,PMINORFRAC,KINDMINOR, lacc) 
...
END INTERFACE
INTERFACE
SUBROUTINE RRTM_TAUMOL7_CPU (KIDIA,KFDIA,KLEV,P_TAU,&
 & P_TAUAERL,P_FAC00,P_FAC01,P_FAC10,P_FAC11,P_FORFAC,P_FORFRAC,K_INDFOR,K_JP,K_JT,K_JT1,P_ONEMINUS,&
 & P_COLH2O,P_COLO3,P_COLCO2,P_COLDRY,K_LAYTROP,P_SELFFAC,P_SELFFRAC,K_INDSELF,PFRAC,&
