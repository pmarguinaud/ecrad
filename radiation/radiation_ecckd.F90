...
contains
  ...
  subroutine read_ckd_model_GPU(this, filename, iverbose, lacc)
    ...
    ! derived type
    call this%spectral_def%read_GPU(file, lacc=lacc);
    ...
    do jgas = 1, this%ngas
      ...
      call this%single_gas(jgas)%read_GPU(file, constituent_id(istart:inext-2), i_gas_code, lacc=lacc)
      istart = inext
    end do
...
!NEC$ select_vector
  ...
  subroutine read_ckd_model_CPU(this, filename, iverbose)
    ...
    ! Read the spectral definition information into a separate
    ! derived type
    call this%spectral_def%read_CPU(file);
    this%ng = this%spectral_def%ng
    ...
    do jgas = 1, this%ngas
      ...
      ! end if
      this%i_gas_mapping(i_gas_code) = jgas;
      call this%single_gas(jgas)%read_CPU(file, constituent_id(istart:inext-2), i_gas_code)
      istart = inext
    end do
